...
const AddNewsFeed = () => {
  return (
    <>
<div  className="add_newsfeed container">
  ...
  <div className="row prog">
    ...
    <div className="col-md-4 ">
      <div className="card addnews_card">
        ...
        <div className="card-body">
          <form id="news-form" data-parsley-validate data-parsley-focus="none" className="php-email-form">
            <div className="form-group mt-3">
              ...
              <input autoComplete="off" type="text" className="form-control" name="subject" id="txtAuthor" />
            </div>
            <div className="form-group mt-3">
              <label translate="yes" style={{paddingBottom: 5}}>News Heading</label>
              <textarea autoComplete="off" className="form-control" name="message" rows={5} id="txtHeading" required defaultValue={""} />
            </div>
            <div className="form-group mt-3">
